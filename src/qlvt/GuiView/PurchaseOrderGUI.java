...
public class PurchaseOrderGUI extends JDialog {
    private JTextField txtMaPhieuNhap, txtMaNhanVien, txtMaNhaCungCap;
    private JFormattedTextField txtNgayNhap;
    private JButton btnSave, btnDelete, btnUpdate;
        ...
        purchaseOrderTable.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                ...
                if (selectedRow != -1) {
                    ...
                    txtMaNhaCungCap.setText(tableModel.getValueAt(selectedRow, 3).toString());
    ...
    private void initUI() {
        ...
        tableModel = new DefaultTableModel(new Object[]{"Mã Phiếu Nhập", "Ngày Nhập", "Mã Nhân Viên", "Mã Nhà Cung Cấp"}, 0);
        ...
        for (JButton button : new JButton[]{btnSave, btnUpdate, btnDelete,btnAddDetail,btnUpdateDetail,btnDeleteDetail}) {
