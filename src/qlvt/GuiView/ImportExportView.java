...
public class ImportExportView extends JPanel {
    ...
    private JScrollPane createImportTable() {
        DefaultTableModel importTableModel = new DefaultTableModel(new Object[]{"Mã Phiếu Nhập", "Ngày Nhập", "Mã Nhân Viên", "Mã Nhà Cung Cấp"}, 0);
    ...
    private JScrollPane createExportTable() {
        DefaultTableModel exportTableModel = new DefaultTableModel(new Object[]{"Mã Phiếu Xuất", "Ngày Xuất", "Mã Nhân Viên"}, 0);
